            ...
            <div class="container" style="background-color: white; height: 1100px;">
                    ...
                    <div class="row">
                        ...
                        <div class=" col-sm-3 scrapbox" >
                            ...
                            <h4  style="text-align: center; color:black;margin-top: 0px; font-weight: bold;"><%= scrapKartModel.getPrice("Tin")%> per kg  <a onclick="document.getElementById('id01').style.display='block'"><img src="images/edit.png" height="20" width="20" ></a></h6>
